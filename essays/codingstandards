...
<img width="300px" class="rounded float-start pe-4" src="../img/codingstandards/error.jpg">
...
<img width="300px" class="rounded float-start pe-4" src="../img/codingstandards/checkmark.jpg">  
